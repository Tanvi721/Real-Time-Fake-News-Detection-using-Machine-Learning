...
def load_data():
    ...
    fake_url = "https://raw.githubusercontent.com/TrainingByPackt/Applied-Machine-Learning-with-Python/master/Datasets/fake_or_real_news.csv"

    df = pd.read_csv(fake_url)
